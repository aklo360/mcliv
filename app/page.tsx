  ...
  return (
    <main className="fade-in">
      ...
      <section id="about" className="mx-auto max-w-3xl px-6 py-20">
        ...
        We develop limited-run capsule collections and collaborative activations that subvert the way we think about the world while creating lasting transformative impact beyond mere spectacle. 
        <br />
        <br />
